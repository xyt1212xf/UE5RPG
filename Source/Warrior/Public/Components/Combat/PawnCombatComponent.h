...
protected:
	virtual void ToggleCurrentEquippedWeaponCollision(bool bShouldEanble);
	virtual void ToggleBodyCollisionBoxCollision(bool bShouldEanble, EToggleWeaponType InToggleWeaponType);
